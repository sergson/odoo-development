...
class InvoiceBankAccount(models.Model):
    ...
    company_bank_account = fields.Many2one('res.partner.bank', 'Company bank account', ondelete='set null', default=default_company_bank_account, help='Select company bank account for this invoice' )
    partner_bank_account = fields.Many2one('res.partner.bank', 'Partner bank account', ondelete='set null', help='Select partner bank account for this invoice')
