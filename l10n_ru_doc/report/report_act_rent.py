...
class RuActReportRent(osv.AbstractModel):
    _name = 'report.l10n_ru_doc.report_act_rent'
    def render_html(self, cr, uid, ids, data=None, context=None):
        report_obj = self.pool['report']
        report = report_obj._get_report_from_name(
            cr, uid, 'l10n_ru_doc.report_act_rent'
        )
        docargs = {
            'helper': QWebHelper(),
            'doc_ids': ids,
        ...
        return report_obj.render(
            cr, uid, ids, 'l10n_ru_doc.report_act_rent',
